"""
Standalone test for Phase 1 + Phase 2 as a single graph-based Workflow:
data_analyst -> data_formatter -> charting_specialist -> charting_formatter

Run with:
    uv run python test_graph_phase2.py "your question here"
"""
import asyncio
import logging
import sys
...
logger = logging.getLogger("test_graph_phase2")
...
async def main():
    ...
    print("====================================================================")
    print("Testing Phase 1 + 2 as a graph-based Workflow")
    ...
    try:
        ...
        print("\n--------------------------------------------------------------------")
        print("Final event (should be the charting formatter's structured output):")
        print("--------------------------------------------------------------------")
        if events:
            last_event = events[-1]
